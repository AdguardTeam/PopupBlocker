...
// @name:ca Bloquejador de finestres emergents AdGuard (Beta)
...
// @name:mk Блокатор на скокачки прозорци AdGuard (Beta)
...
// @name:sr-Latn AdGuard blokator iskačućih prozora (Beta)
// @name:sv AdGuard Popup-blockerare (Beta)
