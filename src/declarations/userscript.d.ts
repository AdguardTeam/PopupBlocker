...
// API specific to Tampermonkey

declare function GM_addValueChangeListener(name:string, cb:(name:string, old_value:number|boolean|string, new_value:number|boolean|string, remote:boolean)=>void):number
