# AdGuard Popup Blocker Changelog
...
- Made `URL` consistent in userscript's metadata [#341].
...
- `@author` header to userscript's metadata [#337].
...
- updated icon of the AdGuard Popup Blocker [#335].
...
- issue with displaying websites in the wrong places in the Allowed
  and Silenced lists on options page [#305].
...
- issue with displaying options in menu when long URL is blocked [#250].
...
- Catalan, Macedonian, Serbian (Latin), and Swedish locales [#326].
...
- Exclude all websites that `tinyShield` is executed [#316].
...
- conflicts with Wombat.js library [#291].
- github.com [#297].
- trailing spaces in meta headers [#301].

[#291]: https://github.com/AdguardTeam/PopupBlocker/issues/291
...
[#275]: https://github.com/AdguardTeam/PopupBlocker/issues/275
...
- build is now using [rollup].
- userscript's options page is now rendered with [preact].

[rollup]: https://rollupjs.org/
[preact]: https://preactjs.com/

[Unreleased]: https://github.com/AdguardTeam/PopupBlocker/compare/v2.5.119-beta.1...HEAD
[2.5.119-beta.1]: https://github.com/AdguardTeam/PopupBlocker/compare/v2.5.118-beta.1...v2.5.119-beta.1
