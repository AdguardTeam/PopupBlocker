 ...
 */
function toPromise(stream:NodeJS.ReadableStream, resolveWithContent?:true):Promise<string>
function toPromise(stream:NodeJS.ReadableStream, resolveWithContent?:boolean):Promise<string|void> {
