import getMessage from '../../src/platform/userscript/get_message';
import I18nService from '../../src/localization/I18nService';
...
describe('Localization', function() {
    ...
    describe('parseMessage', function(){
        ...
        it('preserves plain texts', function() {
            ...
            const parsed = i18nService.parseMessage(input, context);
    ...
    describe('translate', function() {
        ...
        /***************************************************************************
            var RESOURCE_USERSCRIPT_TRANSLATIONS = {
                "en": {
                    'phrase1': 'a{{2}}b{{1}}c{{0}}',
                    'phrase2': 'd{{1}}e{{0}}f',
